...
class ColorTransform(BaseTransform):
    ...
    def _get_mag(self):
        ...
        mag = random.uniform(self.min_mag, mag) if self.random else mag
        return mag
...
class Color(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.adjust_color(img, mag).astype(img.dtype)
...
class Brightness(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.adjust_brightness(img, mag).astype(img.dtype)
...
class Contrast(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.adjust_contrast(img, mag).astype(img.dtype)
...
class Sharpness(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.adjust_sharpness(img, mag).astype(img.dtype)
...
class Solarize(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.solarize(img, mag).astype(img.dtype)
...
class Posterize(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.posterize(img, math.ceil(mag)).astype(img.dtype)
...
class AutoContrast(ColorTransform):
    ...
    def _transform_img(self, results: dict, mag: float) -> None:
        ...
        for key in results['img_fields']:
            img = results[key]
            results[key] = mmcv.auto_contrast(img).astype(img.dtype)
