...
class MSDeformAttn(nn.Module):
    def __init__(self, d_model=256, n_levels=4, n_heads=8, n_points=4, decoder=False, rgb_branch=False, t_branch=False, modality_crossover=False, modality_decoupled=False):
        """
